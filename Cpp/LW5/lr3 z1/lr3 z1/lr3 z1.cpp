...
int main() {
    ...
    // Створюємо студентів
    student* s1 = new student("Нiкiтюк Олександра", "03.04.2008", "ХПФК", "38068...", "ПI", 3);
    student* s2 = new student("Iванов Петро", "10.10.2007", "ХПФК", "38050...", "ПI", 2);
    ...
    // Створюємо викладача
    teacher* t1 = new teacher("Коваленко Марiя", "25.02.1980", "ХПФК", "380501234567", "Доцент", 15);
    people.push_back(t1);

    // АГРЕГАЦІЯ: викладач має студентів
    t1->addStudent(s1);
    t1->addStudent(s2);
